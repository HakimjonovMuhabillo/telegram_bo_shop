...
def create_table_users():
    database = sqlite3.connect('N_shop.db')
...
def insert_products_table():
    ...
    (1, 'Лаваш говяжий', '28000', 'Помидоры, Мясо, огурчики, чипсы', 'media/lavash_1.jpg'),
    (1, 'Лаваш куриный', '28000', 'Помидоры, Мясо, огурчики, чипсы', 'media/lavash_1.jpg'),
    (1, 'Лаваш говяжий с сыром', '28000', 'Помидоры, Мясо, огурчики, чипсы, сыр', 'media/lavash_1.jpg')
...
# Функия для получения ID карточки пользователя
...
def order():
    ...
    order_total_price_id INTEGER REFERENCES order_total_price(order_total_price_id),
